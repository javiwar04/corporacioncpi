...
const seeds: Seed[] = [
  ...
  { n: 1, status: "sold", points: "183,45 472,45 472,148 183,148", cx: 327, cy: 96, phase: "norte", area: 650 },
  { n: 2, status: "sold", points: "183,150 472,150 472,235 183,235", cx: 327, cy: 192, phase: "norte", area: 650 },
  ...
  { n: 10, status: "sold", points: "700,430 906,430 906,638 700,638", cx: 803, cy: 534, phase: "sur", area: 1200 },
  { n: 11, status: "sold", points: "480,430 692,430 692,638 480,638", cx: 586, cy: 534, phase: "sur", area: 1200 },
  { n: 12, status: "sold", points: "183,430 472,430 472,638 183,638", cx: 327, cy: 534, phase: "sur", area: 1200 },
];

export const imanaUnits: PropertyUnit[] = seeds.map((s) => {
  const code = `Bodega ${s.n}`;
  // Las bodegas 1 y 2 ya están construidas y en operación: se muestran con foto real
  // de obra (dron, julio 2026) en lugar del render.
  const built = s.n === 1 || s.n === 2;
  return {
    id: `imana-b${s.n}`,
    projectId: "imana",
    code,
    ...
    description:
      s.status === "available"
        ...
        : "Bodega vendida.",
    coverImage: built ? "/imana/bodegas-1-2.webp" : "/imana/render-1.webp",
    gallery: built
      ? ["/imana/bodegas-1-2.webp", "/imana/bodegas-aereo.webp", "/imana/interior.webp"]
      : ["/imana/render-1.webp", "/imana/interior.webp", "/imana/side.webp"],
